                    ...
                    <div class="home_index_vnindex pt-1 pb-2" style="background:#ffffff91 !important;border-radius:0px !important">
                        ...
                        <div class="home_index_child" style="background:#ffffffe6 !important">
                            <div class="col-lg-12" style="padding:10px;">
                                ...
                                <i class="py-2">- <span style="font-family: auto;">Chú giải xếp hạng TA/FA</span> : </i> <i onclick="JS_Des.noteTaFa()" style="color:#3ac500" class="far fa-eye"></i>
                            </div>
                        </div>
                        <!-- biểu đồ FireAnt -->
                        <div class="home_index_child " style="background:#ffffffe6 !important">
                            <div class="col-lg-12" style="padding:10px;">
                                ...
                                <iframe style="width:100%" height="620" src="https://fireant.vn/dashboard" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen>
                                </iframe>
                            </div>
                        </div>
                    </div>
