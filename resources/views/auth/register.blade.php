            ...
            <div class="col-md-5">
                <div class="card" style="background:#182d51b0;">
                    <div class="card-header">
                        <div class="row px-xl-4 px-sm-4 px-3">
                            <div class="col-2 ms-auto px-1">
                    ...
                    <!-- <div class="card-body">
                        <form method="POST" action="{{ route('checkLogin') }}">
                            ...
                            <div class="row mb-3">
                                <label for="email"
                                    class="col-md-4 col-form-label text-md-end" style="color: azure;">{{ __('Địa chỉ email') }}</label>
                            ...
                            <div class="row mb-3">
                                <label for="password"
                                    class="col-md-4 col-form-label text-md-end" style="color: azure;">{{ __('Mật khẩu') }}</label>
                    ...
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-12">
                                <input placeholder="Nhập tên..." id="name" type="text" class="form-control" name="name" value="{{ old('name') }}" autocomplete="name" autofocus>                    
                                @error('name')
                                      <script>
                                         Swal.fire({
                                            position: 'top-start',
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-12">
                                <input placeholder="Nhập địa chỉ email..." id="email" type="email" class="form-control" name="email" value="{{ old('email') }}" autocomplete="email">
                                    @error('email')
                                      <script>
                                         Swal.fire({
                                            position: 'top-start',
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-12">
                                <input placeholder="Nhập mật khẩu..." id="password" type="password" class="form-control" name="password"  autocomplete="new-password">
                                   @error('password')
                                      <script>
                                         Swal.fire({
                                            position: 'top-start',
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-12">
                                <input placeholder="Nhập lại mật khẩu..." id="password-confirm" type="password" class="form-control" name="password_confirmation"  autocomplete="new-password">
                            </div>
                        </div>
