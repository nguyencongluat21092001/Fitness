function JS_About(baseUrl, module, controller) {
    this.module = module;
...
JS_About.prototype.loadevent = function (oForm) {
    var myClass = this;
 ...
 * @return void
 */
JS_About.prototype.fireAntChart = function () {
 ...
 */
JS_About.prototype.addrow = function(arrResult) {
    var id = broofa();
    var html = '';
    // stt
    ...
    html += '<td style="vertical-align: middle;" align="center"><span class="text-cursor text-warning" onclick="JS_About.fireAntChart(\'' + id + '\')"> <i class="far fa-eye"></i></span></td>';
    // html += '</tr>';
 ...
 * @return void
 */
JS_About.prototype.index = function () {
    var myClass = this;
 ...
 * @return void
 */
JS_About.prototype.loadData = function (oForm) {
    var myClass = this;
 ...
 * @return void
 */
JS_About.prototype.edit = function (id) {
...
function click2(id, type) {
    ...
    $("#"+type+"_" + id).focusout(function(){
        ...
        if(text != $(".span_" + type + '_' + id).html()){
            JS_About.updateDataFinancial(id, type, $(".span_" + type + '_' + id).html());
        }
    })
}
/**
 ...
 */
JS_About.prototype.updateDataFinancial = function(id, column, value = '') {
    var myClass = this;
 ...
 * Cập nhật khi ở màn hình hiển thị danh sách
 */
JS_About.prototype.searchDataCP = function(oFormData) {
    var myClass = this;
    var url = myClass.urlPath + '/searchDataCP';
 ...
 * @return void
 */
JS_About.prototype.noteTaFa = function () {
